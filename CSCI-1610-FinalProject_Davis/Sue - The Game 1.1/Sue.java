...
/**
 * Sue  - Sue is our hero. A fun loving dog who just wants to roam free and eat all the treats she can. Once collecting
 * the bones in her pocket, she likes to deposit them in her doghouse for later. (She likes to be prepared for anything).
 * Sue can do typical dog things, namely:
 * 1) Poop on the ground  (Press the "P" key) when pocket is at max amount.
...
public class Sue extends Actor
{
    ...
    public void checkKeyPress()
    {
        ...
        // If the pocket is full then poop and remove 5 from the pocket.                   
        if (Greenfoot.isKeyDown("p") )
        {
            MyWorld myworld = (MyWorld)getWorld();   // <-- Cast the world to a variable to create poop. Ha.
            
            if (myworld.pocketLabel.pocketScore == myworld.pocketLabel.MAX_AMOUNT)
            {
                ...
                GreenfootSound fart = new GreenfootSound("quickfart.wav");
                fart.setVolume(100);
                fart.play();
    ...
    private void checkTouching()
    {
        ...
        if (isTouching(Bone.class))
        {
            ...
            GreenfootSound chomp = new GreenfootSound("chomp.wav");
            chomp.setVolume(80);
            ...
            else if (world.pocketLabel.pocketScore < world.pocketLabel.MAX_AMOUNT)
                {
    ...
    private void peeOnHydrant()
    {
        if (Greenfoot.isKeyDown("space"))
        {
            ...
            // Create sound
            GreenfootSound pee = new GreenfootSound("pee.wav");
            pee.setVolume(80);
            pee.play();
    ...
    private void catchDog()
    {
        ...
        // Create barking sound and set volume.
